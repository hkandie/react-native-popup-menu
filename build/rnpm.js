(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined'
        ? factory(exports, require('react-native'), require('react'))
        : typeof define === 'function' && define.amd
          ? define(['exports', 'react-native', 'react'], factory)
                    ...
                    (function (_React$Component) {
                        ...
                        function DeprecatedComponent() {
                            ...
                            _this = _possibleConstructorReturn(
                                this,
                                (_getPrototypeOf2 = _getPrototypeOf(DeprecatedComponent)).call.apply(
                                    _getPrototypeOf2,
                                    [this].concat(args)
                                )
                            );
        ...
        function createUnionTypeChecker(arrayOfTypeCheckers) {
            ...
            function validate(props, propName, componentName, location, propFullName) {
                for (var i = 0; i < arrayOfTypeCheckers.length; i++) {
                    var checker = arrayOfTypeCheckers[i];
                    if (
                        checker(props, propName, componentName, location, propFullName, ReactPropTypesSecret_1) == null
                    ) {
                        return null;
                    }
                }
                    ...
                    _createClass(EnhanceContext, [
                        {
                            ...
                            value: function render() {
                                ...
                                return React__default.createElement(Context.Consumer, null, function (value) {
                                    ...
                                    var custom =
                                        ((_custom = {}),
                                        _defineProperty(_custom, propName, value),
                                        _defineProperty(_custom, 'ref', forwardedRef),
                                        _custom);
    ...
    var Backdrop =
        ...
        (function (_Component) {
            ...
            function Backdrop() {
                ...
                _this = _possibleConstructorReturn(
                    this,
                    (_getPrototypeOf2 = _getPrototypeOf(Backdrop)).call.apply(_getPrototypeOf2, [this].concat(args))
                );
            ...
            _createClass(MenuProvider, [
                ...
                },
                {
                    ...
                    value: function _beforeClose(menu) {
                        ...
                        var hideMenu =
                            (this.optionsRef && this.optionsRef.close && this.optionsRef.close()) || Promise.resolve();
                ...
                },
                {
                    ...
                    value: function _notify(forceUpdate) {
                        ...
                        var next =
                            this._menuRegistry.getAll().find(function (menu) {
                                return menu.instance.isOpen();
            ...
            _createClass(MenuOption, [
                ...
                },
                {
                    ...
                    value: function render() {
                        ...
                        var rendered = React__default.createElement(
                            reactNative.View,
                            {
                                style: [defaultStyles.option, customStyles.optionWrapper, style],
                            },
  ...
  */
    ...
    function computeProperties(_ref4, placement, preferredPlacement, isRTL) {
        ...
        var bestPlacement =
            prices[preferredPlacement] === bestPrice
                ? preferredPlacement
                : Object.keys(prices).find(function (pl) {
                ...
                },
                {
                    ...
                    value: function close() {
                        ...
                        return new Promise(function (resolve) {
                            reactNative.Animated.timing(_this2.state.scaleAnim, {
                                duration:
                                    _this2.props.closeAnimationDuration !== undefined
                                        ? _this2.props.closeAnimationDuration
                                        : CLOSE_ANIM_DURATION,
                                toValue: 0,
                                easing: reactNative.Easing.in(reactNative.Easing.cubic),
                                useNativeDriver: USE_NATIVE_DRIVER,
    ...
    var dynamicAnchorStyle = function dynamicAnchorStyle(_ref6) {
        ...
        switch (placement) {
            ...
            case 'top':
                return (
                    (_ref7 = {}),
                    _defineProperty(_ref7, start, offset),
                    _defineProperty(_ref7, 'transform', [
                        {
            ...
            case 'bottom':
                return (
                    (_ref8 = {}),
                    _defineProperty(_ref8, start, offset),
                    _defineProperty(_ref8, 'transform', [
                        {
                            translateY: anchorOffset,
                        },
                        {
    ...
    var MenuContext = deprecatedComponent(
