...
export default class ContextMenu extends React.Component {
  ...
  componentDidMount() {
    // @ts-expect-error TS(2339): Property 'scaleAnim' does not exist on type 'Reado... Remove this comment to see the full error message
...
// public exports
// @ts-expect-error TS(2339): Property 'computePosition' does not exist on type ... Remove this comment to see the full error message
ContextMenu.computePosition = computePosition;
// @ts-expect-error TS(2339): Property 'fitPositionIntoSafeArea' does not exist ... Remove this comment to see the full error message
