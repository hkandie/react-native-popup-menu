...
const BasicExampleComponent = () => {
  const [state, setState] = React.useState({ renderer: ContextMenu });
  ...
  return (
    ...
    >
      ...
      <MenuOptions customStyles={optionsStyles}>
        <MenuOption
          text='Context Menu'
          onSelect={() => setState({ renderer: ContextMenu })}
        />

        <MenuOption
          text='Slide-in Menu'
          onSelect={() => setState({ renderer: SlideInMenu })}
        />

        <MenuOption
          text='Popover'
          onSelect={() => setState({ renderer: Popover })}
        />
