...
describe('MenuOption', () => {
  const makeMockContext = ({ optionsCustomStyles, onSelect, closeMenu }: any = {}) => ({
    menuActions: {
      _getOpenedMenu: () => ({
  ...
  it('should render component with custom styles', () => {
    ...
    expect(normalizeStyle(view.props.style)).toEqual(objectContaining(customStyles.optionWrapper));

    expect(normalizeStyle(text.props.style)).toEqual(objectContaining(customStyles.optionText));
  });
  ...
  it('should render component with inherited custom styles', () => {
    ...
    expect(normalizeStyle(view.props.style)).toEqual(objectContaining(optionsCustomStyles.optionWrapper));
